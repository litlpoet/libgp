...
const Eigen::VectorXd& SampleSet::x(size_t k) { return *inputs.at(k); }

double SampleSet::y(size_t k) { return targets.at(k); }

const std::vector<double>& SampleSet::y() { return targets; }
...
size_t SampleSet::size() { return n; }
...
bool SampleSet::empty() { return n == 0; }
